...
Route::delete('/question/deactivated', ['uses' => 'API\QuestionController@getDeactivatedQuestions']);
Route::patch('/question/activated', ['uses' => 'API\QuestionController@getActivatedQuestions']);
